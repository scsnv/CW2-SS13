...
#define JOB_CO							"Platoon Leader"
#define JOB_XO							"Deputy Platoon Leader"
#define JOB_SO							"Platoon Sergeant"
...
#define JOB_PILOT						"Alpha-Bravo Section Leader"
#define JOB_CREWMAN						"Charlie-Delta Section Leader"
